...
- **Warna & ukuran font stiker**: seluruh teks **MERAH `#d62828`** (permintaan pemilik; satu konstanta `MERAH` agar ketiga baris tak lepas sinkron — merah pekat, bukan `#f00`, supaya tetap terbaca di atas template terang maupun gradasi pastel bawaan). Ukurannya diperbesar: `Hai, aku` **14pt**, kategori kelas **16pt**, nama sampai **34pt**.
