...
### 🎓 Kurikulum bulanan — 4 tema per bulan langganan (migrasi 0098)
Ide Bermain kini berjalan sebagai **kurikulum per ANAK**, bukan daftar materi lepas.

- **Kohortnya per anak** dan mengikuti **jumlah bulan berlangganan** — bukan tanggal kalender. Kakak yang sudah berlangganan 3 bulan membuka tema bulan ke-3; adik yang baru sebulan masih di bulan ke-1, dan **tema kakak tidak ikut terbuka untuknya**. Halaman kurikulum selalu menyebut nama anak yang sedang dibuka, dan tema terkunci menyebut kapan ia terbuka.
- **Bulan depan tampil judulnya saja**; tema yang sudah terbuka **tetap terbuka selamanya**.
...
- **Satu siklus = satu bulan kalender.** Membayar 12 bulan sekaligus **tidak** membuka 12 bulan kurikulum di hari yang sama — ia hanya menaikkan batasnya; temanya tetap keluar sebulan sekali. Sebaliknya, bulan saat langganan tidak aktif tak menambah hitungan.
- **Kategori usia dibekukan sepanjang satu siklus.** Umur anak dihitung pada **awal siklus**, jadi ulang tahun di tengah bulan tak mengganti tema yang sedang dikerjakan. Siklus berikutnya menghitung umurnya lagi dari awal — anak yang sudah 4 tahun pindah ke kategori 4 tahun di situ.
- **Naik kategori berarti mulai dari bulan ke-1 kategori itu**, bukan langsung terbuka sebanyak total bulan berlangganan. Tema kategori sebelumnya **tetap terbuka selamanya**.
...
- **🎈 Tema kurikulum** — tampil ke orang tua & anak, dan menempati satu posisi (bulan ke-N · minggu ke-M) di kategori usianya. Ini yang berjalan sekarang.
- **🎪 Materi event offline** — untuk menyiapkan bahan event. **Tidak tampil** di Ide Bermain, dan **tidak** menghabiskan slot minggu mana pun, jadi tak mengganggu hitungan kurikulum.

Materi event ditandai **🎪 EVENT** di daftar admin.

**Sesudah event-nya selesai**, materinya bisa dipakai jadi tema: pilih materi event itu di dropdown **⧉ Duplikat**, tekan Duplikat — salinannya otomatis menjadi **tema**, lalu Anda pilih kategori usianya dan posisinya terisi otomatis. Materi event aslinya tetap utuh.
