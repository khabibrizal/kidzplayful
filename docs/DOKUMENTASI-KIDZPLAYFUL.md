...
Menu baru `/catatan-tema` — ditautkan dari dashboard admin, Area Guru, dan Area Psikolog. Guru/psikolog menulis catatan perkembangan **per tema** (naratif + rubrik PAUD opsional), terpisah dari checklist orang tua dan selalu menyebut penulis & perannya di rapor. Psikolog hanya melihat anak yang pernah konsultasi dengannya.
