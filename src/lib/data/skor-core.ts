// src/lib/data/skor-core.ts — logika inti catat hasil main (dipakai Server Action & REST API).
// Menerima client Supabase dari pemanggil (cookie-scoped utk web, token-scoped utk mobile) — RLS berlaku.
...
export async function catatHasilCore(supabase: SupabaseClient, input: InputHasil) {
